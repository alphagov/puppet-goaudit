...
class goaudit (
  ...
  Boolean $service_enable = $goaudit::params::service_enable,
  ...
  Boolean $output_stdout_enabled = $goaudit::params::output_stdout_enabled,
  Integer $output_stdout_attempts = $goaudit::params::output_stdout_attempts,
